package com.test.taskmanagement.init;
...
public class PostgresInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    private static final String TEST_DATABASE = "task_management_test";
    private static final String USER_NAME = "task_test";
    private static final String PASSWORD = "task_test";
